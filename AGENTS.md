...
5. **Applied Governance Stack**:
   ...
   - **Applied Coding Profiles**: `.agents/.rules/governance/profiles/languages/javascript.md, .agents/.rules/governance/profiles/languages/css.md, .agents/.rules/governance/profiles/frameworks/nodejs.md`
