...
export const registeredLessons = [
  {
    ...
    loadLesson: () =>
      import('./01-build-sidebar-lesson.js').then((module) => module.BuildSidebarLesson),
  },
  {
    lessonId: '02-build-top-navigation',
    lessonTitle: 'Build Top Navigation',
    loadLesson: () =>
      import('./02-build-top-navigation-lesson.js').then(
        (module) => module.BuildTopNavigationLesson
      ),
  },
  {
    ...
    loadLesson: () =>
      import('./03-build-custom-element-lesson.js').then(
        (module) => module.BuildCustomElementLesson
      ),
  },
  {
    ...
    loadLesson: () =>
      import('./04-build-web-component-lesson.js').then((module) => module.BuildWebComponentLesson),
  },
  {
    lessonId: '05-clean-web-component-with-adopted-stylesheets',
    lessonTitle: 'Clean Web Component With Adopted Stylesheets',
    loadLesson: () =>
      import('./05-clean-web-component-with-adopted-stylesheets-lesson.js').then(
        (module) => module.CleanWebComponentWithAdoptedStylesheetsLesson
      ),
  },
  {
    ...
    loadLesson: () =>
      import('./06-modular-web-components-lesson.js').then(
        (module) => module.ModularWebComponentsLesson
      ),
  },
  {
    ...
    loadLesson: () =>
      import('./07-build-ui-user-avatar-lesson.js').then(
        (module) => module.BuildUiUserAvatarLesson
      ),
  },
  {
    ...
    loadLesson: () =>
      import('./08-smell-of-enterprise-lesson.js').then((module) => module.SmellOfEnterpriseLesson),
  },
  {
    lessonId: '09-human-first-script-demo',
    lessonTitle: 'Human-First Script Demo',
    loadLesson: () =>
      import('./09-human-first-script-demo-lesson.js').then(
        (module) => module.HumanFirstScriptDemoLesson
      ),
  },
];
