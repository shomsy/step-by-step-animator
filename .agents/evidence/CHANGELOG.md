...
1. `[doc][done] 2026-03-27 15:18 - Organized .agents responsibilities into backlog, bugs, governance, review, planning, and evidence lanes; moved the sanitizer concern from TODO into BUGS` - `.agents/README.md`, `AGENTS.md`, `README.md`, `.agents/backlog/BACKLOG.md`, `.agents/bugs/BUGS.md`, `.agents/governance/QUALITY.md`, `.agents/review/REVIEWS.md`, `.agents/planning/PLAN.md`, `.agents/evidence/TODO.md`, `.agents/planning/ARCHIVE.md`, `.agents/review/bugs.md`, `step-by-step-animator.txt`; `actual: 25m`
1. `[doc][done] 2026-03-27 01:02 - Applied visual-then-logic lesson writing rule across Web Components lessons` - `product/education/lessons/03-build-custom-element/source/lesson.md`, `product/education/lessons/04-build-web-component/source/lesson.md`, `product/education/lessons/05-clean-web-component-with-adopted-stylesheets/source/lesson.md`, `product/education/lessons/06-modular-web-components/source/lesson.md`, `product/education/lessons/07-build-ui-user-avatar/source/lesson.md`, `product/education/lessons/08-smell-of-enterprise/source/lesson.md`, `system/lesson-engine/output/03-build-custom-element.md`, `system/lesson-engine/output/04-build-web-component.md`, `system/lesson-engine/output/05-clean-web-component-with-adopted-stylesheets.md`, `system/lesson-engine/output/06-modular-web-components.md`, `system/lesson-engine/output/07-build-ui-user-avatar.md`, `system/lesson-engine/output/08-smell-of-enterprise.md`, `step-by-step-animator.txt`; `actual: 1h`
1. `[doc][done] 2026-03-27 00:53 - Added two-phase Web Components lesson writing rule` - `AGENTS.md`, `.agents/authoring/LESSON_AUTHORING.md`, `step-by-step-animator.txt`; `actual: 20m`
1. `[lesson][done] 2026-03-27 00:39 - Reordered 07 helper JS after the visual shell` - `product/education/lessons/07-build-ui-user-avatar/source/lesson.md`, `product/education/lessons/07-build-ui-user-avatar/source/scenes.md`, `product/education/lessons/07-build-ui-user-avatar/source/artifacts/js.timeline.md`, `system/lesson-engine/output/07-build-ui-user-avatar.md`, `step-by-step-animator.txt`; `actual: 1h`
...
4. `[todo][done] 2026-03-26 15:26 - Product/System Refactor Backlog cleared` - `.agents/evidence/TODO.md`
...
8. `[todo][done] 2026-03-26 02:15 - Cover lesson compiler contracts completed` - `system/lesson-engine/compile-lesson-package.js`, `tests/contracts`
...
11. `[perf][done] 2026-03-26 01:58 - Split the large Vite main chunk` - `app/main.js`, `animator-engine/choose-lesson/select-lesson-from-location.js`, `system/lesson-engine/register-lesson-packages/index.js`
...
15. `[feature][done] 2026-03-26 - Lesson engine compiler boundary introduced` - `system/lesson-engine/compile-lesson-package.js`, `system/lesson-engine/read-scenes-contract.js`, `animator-engine/play-lesson/listen-to-step/compose-step-narration-text.js`
16. `[feature][done] 2026-03-26 - Lesson source validation command added` - `system/lesson-engine/validate-source-lessons.js`, `package.json`, `AGENTS.md`
