...
const shellCssSteps = [
  ...
  ['host_outline', 'feature-callout', 'outline', '1px solid #f97316', 'Dodajemo tanak helper outline za host element i držimo ga do završnog host rezimea.', 'Host i dalje ostaje spoljašnji API komponente, čak i kada unutrašnji CSS više ne živi u template string-u.'],
...
export const lessonSteps = [
  ...
  describeHtmlElementStep(
    ...
    'Dodajemo `<feature-callout>` host sa `title` i `cta-label` atributima. Host API ostaje isti; menja se samo način na koji komponenta organizuje sopstveni CSS.',
  ...
  describeJsFlowStep(
    ...
    'Unutar guard-a pozivamo `customElements.define(\'feature-callout\', FeatureCallout)`. Od ovog trenutka browser zna kako da upgrade-uje `<feature-callout>` u pravu komponentu i preview dobija render bez style taga u template-u.',
